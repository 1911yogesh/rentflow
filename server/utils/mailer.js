  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .otp-box .label { font-size: 12px; color: #6b7280; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 8px; }
        .otp-box .code  { font-size: 42px; font-weight: 800; color: #1d4ed8; letter-spacing: 8px; }
        .otp-box .timer { font-size: 12px; color: #9ca3af; margin-top: 8px; }
    ...
    <body>
      <div class="wrapper">
        ...
        <div class="body">
          ...
          <p>You're almost there! Use the verification code below to complete your RentFlux account setup.</p>
          <div class="otp-box">
            <div class="label">Your One-Time Password</div>
            <div class="code">${otp}</div>
            <div class="timer">⏱ Valid for 5 minutes only</div>
          </div>
          <p>If you didn't request this, you can safely ignore this email. Someone may have typed your address by mistake.</p>
          <p style="color:#9ca3af; font-size:13px;">Do not share this OTP with anyone.</p>
        </div>
        <div class="footer">
          <p>© ${new Date().getFullYear()} RentFlux · All rights reserved</p>
        </div>
      </div>
    </body>
    </html>
